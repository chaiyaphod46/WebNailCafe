        ...
        <div class="card login-section" style="width: 95vw; max-width: 1000px;">
            <div class="row g-0">
                <div class="col-md-6 d-none d-md-block">
                    <img src="imag/nailcafe1.jpg" alt="login form" class="img-fluid rounded-start" style="width: 100%; height: auto; object-fit: cover;">
                </div>
                <div class="col-md-6 d-flex align-items-center bg-light rounded-end" style="background-color: #fff0f5;">
                    <div class="card-body p-5 text-black">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="pt-1 mb-4">
                                <button class="btn btn-lg btn-block" type="submit">{{ __('เข้าสู่ระบบ') }}</button>
                            </div>
                            <p class="mb-5 pb-lg-2">
                                หากคุณยังไม่ลงทะเบียน <a href="{{url('/register')}}" class="link-color">ลงทะเบียน</a>
                            </p>
                        </form>
